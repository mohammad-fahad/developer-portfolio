    ...
    <section className="relative flex flex-col items-center justify-center py-8 lg:py-20 min-h-screen lg:min-h-[90vh] overflow-hidden">
      <div className="absolute inset-0 -z-10 opacity-[0.03]">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(var(--hero-gradient) 1px, transparent 1px), linear-gradient(90deg, var(--hero-gradient) 1px, transparent 1px)`,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-16 w-full items-center">
        <div className="lg:col-span-7 flex flex-col items-start justify-center order-2 lg:order-1">
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border border-violet-500/20 bg-[var(--badge-bg)] text-violet-300 text-[11px] sm:text-sm mb-4 sm:mb-6">
            <span className="w-1.5 sm:w-2 h-1.5 sm:h-2 rounded-full bg-emerald-400 animate-pulse" />
            Available for opportunities
          </div>

          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold leading-tight text-[var(--text-primary)]">
            {personalData.name}
          </h1>
          ...
          <p className="text-[var(--text-secondary)] text-sm sm:text-base md:text-lg mt-4 sm:mt-6 max-w-2xl leading-relaxed">
            {personalData.subheading}
          </p>

          <div className="flex flex-wrap gap-3 sm:gap-6 mt-6 sm:mt-8">
            <div className="flex items-center gap-1.5 sm:gap-2 text-[var(--text-muted)] text-xs sm:text-sm">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 mt-8 sm:mt-10">
            ...
            <Link
              ...
              target="_blank"
              className="group inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-full border border-[var(--border-color)] text-[var(--text-secondary)] font-medium text-xs sm:text-sm transition-all duration-300 hover:border-violet-500 hover:text-violet-300"
            >
              Download Resume
        ...
        <div className="lg:col-span-5 order-1 lg:order-2 w-full">
          <div className="relative group">
            ...
            <div className="relative bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-2xl overflow-hidden">
              <div className="flex items-center gap-1.5 px-3 sm:px-4 py-2.5 sm:py-3 border-b border-[var(--border-color)]">
                ...
                <span className="ml-2 sm:ml-3 text-[10px] sm:text-xs text-[var(--text-muted)]">flagship-project</span>
              </div>

              <div className="p-4 sm:p-6">
                <div className="flex items-center gap-2 mb-2 sm:mb-3">
                  <span className="px-2 py-0.5 text-[9px] sm:text-[10px] font-medium uppercase tracking-wider text-violet-300 bg-[var(--badge-bg)] rounded-full border border-violet-500/20">
                    Featured Project
                  </span>
                </div>

                <h3 className="text-lg sm:text-2xl font-bold text-[var(--text-primary)] mb-0.5 sm:mb-1">
                  EduFlow
                </h3>
                ...
                <div className="space-y-2 sm:space-y-2.5 mb-4 sm:mb-5">
                  <div className="flex items-center gap-2 sm:gap-2.5 text-xs sm:text-sm">
                    ...
                    <span className="text-[var(--text-secondary)]">Multi-tenant architecture</span>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-2.5 text-xs sm:text-sm">
                    <div className="w-1 sm:w-1.5 h-1 sm:h-1.5 rounded-full bg-violet-400 flex-shrink-0" />
                    <span className="text-[var(--text-secondary)]">RBAC & permission hierarchies</span>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-2.5 text-xs sm:text-sm">
                    <div className="w-1 sm:w-1.5 h-1 sm:h-1.5 rounded-full bg-violet-400 flex-shrink-0" />
                    <span className="text-[var(--text-secondary)]">Next.js + TypeScript + Prisma + PostgreSQL</span>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-2.5 text-xs sm:text-sm">
                    <div className="w-1 sm:w-1.5 h-1 sm:h-1.5 rounded-full bg-violet-400 flex-shrink-0" />
                    <span className="text-[var(--text-secondary)]">Production-ready with testing & security hardening</span>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-1 sm:gap-1.5 mb-4 sm:mb-5">
                  {["Next.js", "TypeScript", "Prisma", "PostgreSQL", "Supabase"].map((tech) => (
                    <span
                      key={tech}
                      className="px-1.5 sm:px-2 py-0.5 text-[9px] sm:text-[10px] font-medium text-[var(--text-muted)] bg-[var(--tag-bg)] rounded-md border border-[var(--border-light)]"
                    >
                      {tech}
                    </span>
                  ))}
