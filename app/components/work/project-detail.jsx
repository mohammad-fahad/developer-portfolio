        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="p-4 sm:p-5 lg:p-6 rounded-xl border border-[var(--border-color)] bg-[var(--bg-primary)]/80 lg:sticky lg:top-24">
              <h3 className="text-[var(--text-primary)] font-semibold text-xs sm:text-sm mb-3 sm:mb-4">Project Overview</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            {project.outcomes.map((outcome, i) => (
              ...
              >
                ...
                <span className="text-[var(--text-secondary)] text-xs sm:text-sm">{outcome}</span>
              </div>
            ))}
          </div>
        </section>
